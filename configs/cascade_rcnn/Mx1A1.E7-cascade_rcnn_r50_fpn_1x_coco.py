...
work_dir = 'det_ckpts/Mx1A1.E3-cascade_rcnn_r50_fpn_1x_coco/'
...
data = dict(
    ...
    val = dict(
        img_prefix = '/local-data/Polli/Datasets/inaturalist2017/exports/val-mini-select/data/',
        classes = classes,
        ann_file = '/local-data/Polli/Datasets/inaturalist2017/exports/val-mini-select/labels.json'),
    test = dict(
