...
auto_scale_lr = dict(base_batch_size=20) # NOTE: Adding this, as I suspect there is version mismatch b/w mmdet-polli configs and mmdet 2.21.0 (the version used in determined image).
